import{d as E,k as j,o as i,c as m,b as p,t as g,D,E as F,F as R,h as $,l as L}from"./vue.esm-bundler-d08935b9.js";/* empty css                                                                     */import{_ as O}from"./_plugin-vue_export-helper-c27b6911.js";import{a as o}from"./styles-58edb9be.js";import"./_commonjsHelpers-725317a4.js";const q=r=>(D("data-v-442ab059"),r=r(),F(),r),z={class:"flex flex-col justify-left items-left"},A=q(()=>p("div",{class:"h-[50px] w-[50px] vrxcolor rounded-[12px]"},null,-1)),G={class:"text-content-light dark:text-content-dark font-thin text-sm"},H={class:"text-content-light dark:text-content-dark font-thin text-sm"},J=E({__name:"VrxColorItem",props:{color:{},name:{}},setup(r){return j(s=>({d03549a8:s.color})),(s,B)=>(i(),m("div",z,[A,p("label",G,g(s.name),1),p("label",H,g(s.color),1)]))}}),K=O(J,[["__scopeId","data-v-442ab059"]]),M={"data-testid":"vrx-color-palette",class:"flex flex-wrap h-full w-full justify-left items-center gap-2"},w=E({__name:"VrxColorPalette",props:{colors:{}},setup(r){return(s,B)=>(i(),m("div",M,[(i(!0),m(R,null,$(s.colors,(N,d)=>(i(),L(K,{key:d,color:N,name:d},null,8,["color","name"]))),128))]))}}),Z={title:"VrxColorPalette",component:w,tags:["autodocs"]},e={render:r=>({components:{VrxColorPalette:w},setup(){return{args:r}},template:`
...
//# sourceMappingURL=VrxColorPalette.stories-1fcdc727.js.map
