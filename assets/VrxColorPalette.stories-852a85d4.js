import{d as w,v as j,o as i,c as m,e as p,t as g,M as F,N as R,F as $,s as D,x as L}from"./vue.esm-bundler-cf734fcd.js";/* empty css                                                                     */import{_ as M}from"./_plugin-vue_export-helper-c27b6911.js";import{a as o}from"./styles-cba61512.js";import"./_commonjsHelpers-de833af9.js";const O=r=>(F("data-v-442ab059"),r=r(),R(),r),q={class:"flex flex-col justify-left items-left"},z=O(()=>p("div",{class:"h-[50px] w-[50px] vrxcolor rounded-[12px]"},null,-1)),A={class:"text-content-light dark:text-content-dark font-thin text-sm"},G={class:"text-content-light dark:text-content-dark font-thin text-sm"},H=w({__name:"VrxColorItem",props:{color:{},name:{}},setup(r){return j(s=>({d03549a8:s.color})),(s,E)=>(i(),m("div",q,[z,p("label",A,g(s.name),1),p("label",G,g(s.color),1)]))}}),J=M(H,[["__scopeId","data-v-442ab059"]]),K={"data-testid":"vrx-color-palette",class:"flex flex-wrap h-full w-full justify-left items-center gap-2"},B=w({__name:"VrxColorPalette",props:{colors:{}},setup(r){return(s,E)=>(i(),m("div",K,[(i(!0),m($,null,D(s.colors,(N,d)=>(i(),L(J,{key:d,color:N,name:d},null,8,["color","name"]))),128))]))}}),Z={title:"VrxColorPalette",component:B,tags:["autodocs"]},e={render:r=>({components:{VrxColorPalette:B},setup(){return{args:r}},template:`
