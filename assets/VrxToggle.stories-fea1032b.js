import{d as z,a as h,j as S,o as k,c as w,b as n,n as i,t as B}from"./vue.esm-bundler-a130895e.js";import{t as C}from"./styles-1a51a98b.js";/* empty css                                                                  */import{_ as E}from"./_plugin-vue_export-helper-c27b6911.js";import"./_commonjsHelpers-725317a4.js";const P={"data-testid":"vrx-toggle",class:"relative inline-flex items-center cursor-pointer"},j=["checked","disabled"],D=z({__name:"VrxToggle",props:{size:{default:"md"},variant:{default:"default"},label:{default:""},disabled:{type:Boolean,default:!1},modelValue:{type:Boolean,default:!1}},emits:["update:modelValue"],setup(e,{emit:T}){const a=e,l=h(a.modelValue),_=()=>{l.value=!l.value,T("update:modelValue",l.value)},d=S(()=>C(a.variant,a.size,a.disabled));return(p,I)=>(k(),w("label",P,[n("input",{type:"checkbox",checked:l.value,class:"sr-only peer",onChange:_,disabled:p.disabled},null,40,j),n("span",{"data-testid":"vrx-toggle-content",class:i(d.value.toggle)},null,2),n("span",{"data-testid":"vrx-toggle-label",class:i(["ml-3 text-sm font-medium",d.value.label])},B(p.label),3)]))}}),s=E(D,[["__scopeId","data-v-4bfb315d"]]),G={title:"VrxToggle",component:s,tags:["autodocs"],argTypes:{modelValue:{description:"binded value with v-model",control:{type:"string"},table:{category:"props",type:{summary:"boolean"}}},size:{description:"size of the toggle",control:{type:"select"},options:["sm","md","lg"],table:{category:"props",type:{summary:"sm | md | lg"},defaultValue:{summary:"md"}}},variant:{description:"color variant",control:{type:"select"},options:["default","red","green","yellow","purple"],table:{category:"props",type:{summary:"ComponentVariant"},defaultValue:{summary:"default"}}},label:{description:"label",control:{type:"text"},table:{category:"props",type:{summary:"string"}}},disabled:{description:"disable the toggle",control:{type:"boolean"},table:{category:"props",type:{summary:"boolean"},defaultValue:{summary:"false"}}}}},m={render:e=>({components:{VrxToggle:s},setup(){return{args:e}},template:`
            <VrxToggle 
                v-bind="args"
...
//# sourceMappingURL=VrxToggle.stories-fea1032b.js.map
