...
It is designed to be used with the component from VireoX library, but can be used independently.
...
The ***VrxLink*** component can be used to create a menu item for your web application.
It has two slots:
