  ...
  <ul>
    <li>
      <component
          ...
          class="father-button flex items-center p-2 text-primary-900 rounded-lg dark:text-neutral-0 hover:bg-primary-100 dark:hover:bg-primary-700"
      ...
      <div v-else>
        <div @click="toggleShowChildren" class="father-button flex items-center p-2 text-primary-900 rounded-lg dark:text-neutral-0 hover:bg-primary-100 dark:hover:bg-primary-700">
          <VrxIcon v-if="config.icon" :icon="config.icon" size="5"/>
