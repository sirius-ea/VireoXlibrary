...
<template>
  <li class="cursor-pointer px-4 py-2 border-b-2 border-b-transparent hover:border-b-[var(--color-primary-400)] active:border-b-[var(--color-primary-400)]"
      :class="[ selected ? 'active border-b-primary-500!' : '']" @click="onLinkClick" :aria-label="tab_name">
      <slot></slot>
  </li>
</template>
